...
// added this ----
// Define an instance of spi_t for SPI0
// spi_t spi2_config = {
//     .hw_inst = spi0,             // Use SPI0 instance
//     .miso_gpio = 16,             // MISO on GPIO16
//     .mosi_gpio = 19,             // MOSI on GPIO19
//     .sck_gpio = 18,              // SCK on GPIO18
//     .baud_rate = 1000000,        // Example baud rate (can adjust as needed)
//     .DMA_IRQ_num = 0,            // Initialize DMA_IRQ_num
//     .set_drive_strength = false, // Adjust if necessary
//     .mosi_gpio_drive_strength = GPIO_DRIVE_STRENGTH_2MA, // Initialize mosi_gpio_drive_strength
//     .sck_gpio_drive_strength = GPIO_DRIVE_STRENGTH_2MA,  // Initialize sck_gpio_drive_strength
//     .tx_dma = 0,                 // Initialize tx_dma
//     .rx_dma = 0,                 // Initialize rx_dma
//     .tx_dma_cfg = {0},           // Initialize tx_dma_cfg
//     .rx_dma_cfg = {0},           // Initialize rx_dma_cfg
//     .dma_isr = NULL,             // Initialize dma_isr
//     .initialized = false,        // Initialize initialized
//     .sem = {0},                  // Initialize sem
//     .mutex = {0},                // Initialize mutex
//     .DMA_IRQ_num = 0,            // Initialize DMA_IRQ_num
//     .mosi_gpio_drive_strength = GPIO_DRIVE_STRENGTH_2MA, // Initialize mosi_gpio_drive_strength
//     .sck_gpio_drive_strength = GPIO_DRIVE_STRENGTH_2MA,  // Initialize sck_gpio_drive_strength
//     .tx_dma = 0,                 // Initialize tx_dma
