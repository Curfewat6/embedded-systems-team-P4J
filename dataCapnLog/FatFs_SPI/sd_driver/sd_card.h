...
// sd_card_t sd_card = {
//     .pcName = "USB Drive (D:)",
//     .spi = &spi2_config,               // Use SPI0 configuration
//     .ss_gpio = 17,                     // GPIO pin for slave select (CS)
//     .use_card_detect = false,           // Use card detect feature
//     .card_detect_gpio = 20,            // GPIO pin for card detect
//     .card_detected_true = 1,           // Logic level high when card detected
//     .set_drive_strength = true,        // Enable GPIO drive strength control
//     .ss_gpio_drive_strength = GPIO_DRIVE_STRENGTH_8MA    // Set drive strength for SS}
// };
...
//     .m_Status = 0,                     // Initialize m_Status
//     .sectors = 0,                      // Initialize sectors
//     .card_type = 0,                    // Initialize card_type
